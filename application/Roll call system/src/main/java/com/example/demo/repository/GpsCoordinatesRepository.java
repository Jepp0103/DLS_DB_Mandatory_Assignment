...
public interface GpsCoordinatesRepository extends JpaRepository<GpsCoordinates,Integer> {
    ...
    @Query(value = "CALL register_student_gps(:studentId, :teacherId, :studentLatitude, :studentLongitude, :gpsRange, '')", nativeQuery = true)
    String registerStudentGps(int studentId, int teacherId, double studentLatitude, double studentLongitude, double gpsRange);
