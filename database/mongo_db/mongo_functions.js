...
db.system.js.insert( //Inserting the function into the database
    {
        _id: "getLectureParticipationRate",
        value : function (lecture_id) {
            const lectureParticipationRate = (db.lecture.aggregate([
                {
                    $match: {_id: lecture_id}
                },
...
db.loadServerScripts(); //To load serverscripts ex. functions for use